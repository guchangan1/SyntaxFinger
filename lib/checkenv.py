...
class CheckEnv:
    ...
    def path_check(self):
        ...
        path.apioutputdir = os.path.join(self.path, 'results')
        path.library = os.path.join(self.path, 'library')
        if not os.path.exists(path.apioutputdir):
            warnMsg = "The apioutput folder is not created, it will be created automatically"
            logging.warning(warnMsg)
            os.mkdir(path.apioutputdir)
